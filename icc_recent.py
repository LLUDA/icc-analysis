#!/usr/bin/env python3
"""
ICC Recent Backtest - Extended Period
=====================================
"""
...
class ICCRecent:
    """Test ICC method on recent market data (last month)"""
    ...
    def run_backtest(self):
        ...
        print("=" * 70)
        print("  ICC RECENT MARKET BACKTEST")
        ...
        for pair in self.pairs:
            ...
            try:
                ...
                if len(df_4h) < 100 or len(df_1h) < 400:
                ...
                if setups:
                    ...
                    for i, s in enumerate(setups, 1):
                        ...
                        print(
                            f"     RR: {s['rr']:.2f}:1 | Corr: {s['correction_pct']:.0f}%"
                        )
